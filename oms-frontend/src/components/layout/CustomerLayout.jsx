    ...
    <div className="min-h-screen bg-background text-on-background flex flex-col font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-8 py-3 bg-white/60 backdrop-blur-xl rounded-full mt-4 mx-auto max-w-7xl border border-white/20 shadow-[0px_20px_40px_rgba(25,28,28,0.06)]">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-2 md:gap-3 ml-1 md:ml-2 pl-2 md:pl-4 border-l border-outline-variant/30 relative group cursor-pointer">
              <span className="hidden md:block text-sm font-semibold text-on-surface truncate max-w-25">{user.name}</span>
