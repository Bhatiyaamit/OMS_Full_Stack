      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.companySubtext}>nitec.store • support@nitec.store</Text>
          </View>
          ...
          <View style={styles.headerRight}>
            ...
            <View style={styles.metaRow}>
              ...
              <Text style={styles.metaValue}>#{order.id.split("-")[0].toUpperCase()}</Text>
            </View>
            <View style={styles.metaRow}>
            ...
            <View style={styles.metaRow}>
              ...
              <View style={[styles.statusPill, isDelivered ? styles.statusPillDelivered : null]}>
                <Text style={[styles.statusText, isDelivered ? styles.statusTextDelivered : null]}>
                  {order.status}
                </Text>
              </View>
            </View>
        ...
        {order.items?.map((item, idx) => (
          <View key={item.id} style={styles.tableRow}>
            ...
            <Text style={[styles.tableCellText, styles.col3]}>{item.quantity}</Text>
            <Text style={[styles.tableCellText, styles.col4]}>{formatMoney(item.priceAtPurchase)}</Text>
        ...
        <View style={styles.summarySection}>
          <View style={styles.summaryBox}>
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryValue}>{formatMoney(order.totalAmount)}</Text>
            </View>
            <View style={styles.summaryRow}>
